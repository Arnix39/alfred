...
void Pigpio::i2cOpen(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cOpen::Request> request,
                     std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cOpen::Response> response)
{
    ...
    else
    {
        ...
        RCLCPP_ERROR(get_logger(),"Failed to open I2C bus %u for device %u.", request->bus, request->address);
    }
}

void Pigpio::i2cClose(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cClose::Request> request,
...
void Pigpio::i2cReadByteData(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cReadByteData::Request> request,
                             std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cReadByteData::Response> response)
{
    ...
    else
    {
        response->value = 0;
        response->has_succeeded = false;
        RCLCPP_ERROR(get_logger(),"Failed to read register %u on device with handle %u.", request->device_register, request->handle);
    }
}

void Pigpio::i2cReadWordData(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cReadWordData::Request> request,
...
void Pigpio::i2cReadBlockData(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cReadBlockData::Request> request,
...
void Pigpio::i2cWriteByteData(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cWriteByteData::Request> request,
                              std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cWriteByteData::Response> response)
{
    ...
    {
        response->has_succeeded = false;
        RCLCPP_ERROR(get_logger(),"Failed to write register %u on device with handle %u.", request->device_register, request->handle);
    }
}

void Pigpio::i2cWriteWordData(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cWriteWordData::Request> request,
...
void Pigpio::i2cWriteBlockData(const std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cWriteBlockData::Request> request,
                               std::shared_ptr<hal_pigpio_interfaces::srv::HalPigpioI2cWriteBlockData::Response> response)
{
    ...
    {
        response->has_succeeded = false;
        RCLCPP_ERROR(get_logger(),"Failed to write data block in register %u on device with handle %u.", request->device_register, request->handle);
    }
}